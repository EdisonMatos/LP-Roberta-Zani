  ...
  texts: {
    ...
    hero: {
      ...
      obsHero: {
        ...
        text: "Atendimento presencial em Guarapari - ES e online para todo Brasil",
      },
      ctaButtonAriaLabel:
    ...
    features: {
      ...
      card2: {
        ...
        title: "Consumidor",
        subtitle:
          "Revisão de contratos bancários e de planos de saúde; defesa em financiamentos de veículos e imóveis; atuação contra práticas abusivas de mercado.",
        description: (
          <div>
            A_Definir
            <br />
    ...
    steps: {
      ...
      cards: {
        card1: {
          ...
          cardDescription:
            "Realizamos uma reunião para entender o caso e identificar suas necessidades.",
        },
        card2: {
          stepNumber: 2,
          cardTitle: "Análise detalhada",
          cardDescription:
            "Análise detalhada de documentos e emissão de parecer técnico e individualizado.",
        },
        card3: {
          stepNumber: 3,
          cardTitle: "Elaboração da estratégia",
          cardDescription:
            "Desenvolvimento de estratégia (judicial ou extrajudicial) personalizada.",
        },
        card4: {
          stepNumber: 4,
